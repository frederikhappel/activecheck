...
public class NagiosServiceReport extends NagiosCheckResult implements
	...
	public boolean hasChanged(NagiosServiceReport report) {
		if (report != null) {
			String md5self = DigestUtils.md5Hex(toString());
			String md5report = DigestUtils.md5Hex(report.toString());
	...
	public int compareTo(NagiosServiceReport o) {
		return o.getStatus().getSeverityOrder()
				- getStatus().getSeverityOrder();
	}

	@Override
	public boolean equals(Object o) {
		if (o instanceof NagiosServiceReport) {
			NagiosServiceReport comparable = (NagiosServiceReport) o;
